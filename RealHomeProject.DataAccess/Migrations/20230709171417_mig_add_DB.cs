    ...
    public partial class mig_add_DB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OurPartner", x => x.ID);
                });

            migrationBuilder.CreateTable(
                name: "PopularRentHome",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RentHomeImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RentHomeName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RentHomeDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RentHomePrice = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PopularRentHome", x => x.Id);
                });
